...
const Navbar = () => {
  ...
  return (
    <nav className="navbar px-4 py-2" style={{ backgroundColor: "#F5C518" }}>
        ...
        <div className="d-flex gap-2">
          {user ? (
            <>
              ...
              <Link to="/create" className="btn btn-dark btn-sm fw-bold">
                + Publicar
              </Link>
            ...
            <>
              ...
              <Link to="/register" className="btn btn-dark btn-sm fw-bold">
                Registrarse
              </Link>
            </>
          )}
